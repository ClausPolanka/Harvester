...
namespace Harvester.Domain.UnitTest
{
    ...
    public class CircularHarvesterUnitTest
    {
        ...
        //  → 1*  2  3      1   4  2  5  3  6             1   4  2  5  3  6
        // →  4   5  6                   
        //    7   8  9      7  10  8 11  9 12             7   8  9
        //   10  11 12
        //   13  14 15      13 14 15                     10  13 11 14 12 15
        ...
        //        ↑
        //[TestCase(5, 3, 5, 5, "N", "15 12 9 6 3 1 4 7 10 13 14 11 8 5 2")]
        public void Odd_number_of_rows_north_and_south_and_a_width_of_two(
            int nrOfRows,
            int nrOfCols,
            int startRow,
            int startCol,
